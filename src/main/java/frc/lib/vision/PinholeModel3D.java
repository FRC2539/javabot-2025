...
public class PinholeModel3D {
    public static Translation2d getTranslationToTarget(Translation3d targetDirectionFromCamera, Transform3d robotToCamera, double targetHeight) {
                ...
                double heightChangePerTranslation = new Transform3d(new Translation3d(), robotToCamera.getRotation()).plus(targetDirectionTransform).getZ();
