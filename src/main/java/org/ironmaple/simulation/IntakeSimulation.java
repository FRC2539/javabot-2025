...
public class IntakeSimulation extends BodyFixture {
    ...
    public IntakeSimulation(
        ...
        this(
                ...
                getIntakeRectangle(
                        driveTrainSimulation, width.in(Meters), lengthExtended.in(Meters), side),
                capacity);
    }
        ...
        intakeRectangle.translate(
                switch (side) {
                    case LEFT ->
                            new Vector2(
                                    0,
                                    driveTrainSimulation.config.bumperWidthY.in(Meters) / 2
                                            + distanceTransformed);
                    case RIGHT ->
                            new Vector2(
                                    0,
    ...
    public final class GamePieceContactListener implements ContactListener<Body> {
        ...
        @Override
        public void persist(
                ContactCollisionData collision, Contact oldContact, Contact newContact) {}
     ...
     *
     *
     * <h2>Obtains the {@link GamePieceOnFieldSimulation} Instances to Be Removed from the Field.
     * </h2>
     *
     ...
     *
     * <p>Game pieces are marked for removal if they have come into contact with the intake during
     * the last {@link SimulatedArena#getSimulationSubTicksIn1Period()} sub-ticks. These game pieces
     ...
     *
     * <p>This method is called from {@link SimulatedArena#simulationPeriodic()} after the game
     * pieces marked for removal have been processed and removed from the field.
     *
