 ...
 * classes.
 *
 * <p>The propelling forces generated by motors are simulated in its subclass, or {@link
...
public abstract class AbstractDriveTrainSimulation extends Body {
     ...
     * {@link org.ironmaple.simulation.SimulatedArena} for instructions on how to add it to the
     * simulation world.
     *
     ...
     * href="https://docs.advantagescope.org/tab-reference/3d-field/">AdvantageScope Field3d</a> or
     * to <a
     ...
     *
     * <p>This method returns the actual chassis speeds of the drivetrain in the simulation,
     * relative to the robot.
     *
     * <p>To simulate the chassis speeds calculated by encoders, use a {@link SwerveDriveSimulation}
     * together with {@link
     * edu.wpi.first.math.kinematics.SwerveDriveKinematics#toChassisSpeeds(SwerveModuleState...)}
